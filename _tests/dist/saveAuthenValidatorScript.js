...
import { authenValidatorScript, txBuilder, wallet1, wallet1Address, wallet1Collateral, wallet1Utxos } from "./setup.js";
...
const refAddress = serializePlutusScript({ code: refScript, version: "V3" }).address;
